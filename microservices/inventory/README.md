```
docker build  --no-cache -t abc_msa_inventory .
docker run -itd  -p 8006:8080 --mount source=inventory_volume,target=/app_data --name inventory_container abc_msa_inventory
```
